...
# (note that the lines under "Enable legacy engine" may also need to be uncommented)
#EXTRA_CPPFLAGS = -static
#LEPT_LDFLAGS = -llept -lz -lpng -ljpeg -lgif -ltiff -lwebp -ljbig -lopenjp2 -llzma -lpcre -lffi -lexpat -lfreetype -lthai -ldatrie -lgmodule-2.0 -lglib-2.0 -lharfbuzz -lzstd -ldeflate -lpixman-1 -ldl
